...
$id = $_GET['delete'];
$query = mysqli_query($db, "DELETE FROM t_artikel WHERE id='$id'");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <hr>
      <h3 align="center" class="text-dark">Admin Page batu-batu Agadew</h3>
      <hr><br>
      <a href="../index.php"><button class="button">Kembali</button></a>
      <a href="?page=add"><button class="btn-info">Jual Batu</button></a><br>
      <div>
        <h3>List Jual baru</h3>
        <?php
